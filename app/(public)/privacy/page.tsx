...
export default function PrivacyPolicy() {
  ...
  return (
    <section>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to PT. Inboxed Digital Indonesia, Centennial
            Tower, Lantai 29, Kav. 24-25 Unit D-E, Jl. Jenderal Gatot Subroto
            No.27 .
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Inboxed, accessible from{" "}
            <a
              href="https://www.inboxed.id"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.inboxed.id
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: support@inboxed.id</li>
      </ul>
    </section>
  );
}
